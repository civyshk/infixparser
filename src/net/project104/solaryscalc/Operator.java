...
import static net.project104.solaryscalc.Constants.*;
...
public enum Operator {
	...
	CIRCLE_SURFACE("SURCIRCLE", 1), TRIANGLE_SURFACE("SURTRIANGLE", 3),
	HYPOTENUSE_PYTHAGORAS("PYTHHYPO", 2), LEG_PYTHAGORAS("PYTHLEG", 2),
	QUADRATIC_EQUATION(null, 3);
